        ...
        if not is_blocked(x, y):
            if libtcod.random_get_int(0, 0, 100) < 80: #80% chance of getting an orc
                ...
                fighter_component = Fighter(\
                    hp=10, defense=0, power=3, xp=35, death_function=monster_death)
                ...
                #create a troll
                fighter_component = Fighter(\
                    hp=16, defense=1, power=4, xp=100, death_function=monster_death)
                ai_component = BasicMonster()
...
def render_all():
    ...
    global fov_map, COLOR_DARK_WALL, COLOR_LIGHT_WALL,\
        COLOR_DARK_GROUND, COLOR_LIGHT_GROUND,\
        fov_recompute
...
def main_menu():
    ...
    while not libtcod.console_is_window_closed():
        ...
        libtcod.console_print_ex(\
            0, SCREEN_WIDTH/2, SCREEN_HEIGHT/2-4, libtcod.BKGND_NONE, libtcod.CENTER,
            'TOMBS OF THE ANCIENT KINGS')
        libtcod.console_print_ex(\
            0, SCREEN_WIDTH/2, SCREEN_HEIGHT-2, libtcod.BKGND_NONE, libtcod.CENTER,
            'By Alf')
